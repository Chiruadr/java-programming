...
Create a method called `printText` which prints the phrase "In a hole in the ground there lived a method" and a newline. <!-- exercise 2.21 and 2.22 have "printText" instead of "printPhrase" -->
